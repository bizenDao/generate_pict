...
RUN mkdir -p /models && \
    wget -q https://huggingface.co/Drditone/safetensors/resolve/2221d81ba5e636be82ed93b7021339d0b4dce264/momoiropony_v15.safetensors \
      -O /models/momoiro-pony-v15.safetensors && \
    echo "Downloaded $(du -h /models/momoiro-pony-v15.safetensors | cut -f1)"
...
COPY --from=downloader /models/momoiro-pony-v15.safetensors \
     /ComfyUI/models/checkpoints/momoiro-pony-v15.safetensors
